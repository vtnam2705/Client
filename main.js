    ...
    data.forEach(function (product) {
        ...
        <div class="card">
                        ...
                        <div class="details">
                            ...
                            <div class="wrapper">
                                <p>Camera trước: ${product.frontCamera} <br> Camera sau ${product.backCamera}</p>
                                <p>${product.desc}</p>
                            </div>
                            <div class="purchase">
...
function renderListCarts(data) {
    ...
    const upQty = document.querySelector(".total-qty");

    upQty.textContent = cartList.length;
...
function cartTotal() {
    ...
    let modalPrice = document.querySelector(".modal-body");
    modalPrice.innerHTML = `your order will be delivered to you in 3-5 working days
    you can pay ${totalProduct} VND by card or any online transaction method after the products have been dilivered to you `;
}
